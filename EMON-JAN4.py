...
os.system('espeak -a 300 " waiting for update emon mim tools"')
os.system('git pull')
...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/emon44220')
time.sleep(5)
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m𝐅𝐨𝐥𝐥𝐨𝐰 𝐦𝐲 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐩𝐫𝐨𝐟𝐢𝐥𝐞")
os.system('espeak -a 300 " FOLLOW MY FACEBOOK PROFILE"')
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/Mim.Mim.Love.Emon.Jan')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/Mim.Mim.Love.Emon.Jan')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
logo =""" 
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[1;91m\033[1;41m\033[1;97m              WELCOME TO EMON TOOLS                 \033[;0m\033[1;91m\033[1;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝

\x1b[1;96m░E░M░O░N░-░M░I░M░ \x1b[38;5;196m
         \033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS EMON BRAND\033[;0m\033[1;91m═══>\033[1;92m
\x1b[38;5;196m╔━━━━━━━━━━━━━━━━━━━━━━━━╦━━━━━━━━━━━━━━━━━━━━━━╗
\x1b[38;5;196m║  \x1b[1;96m𓆩💜𓆪𝐍𝐀𝐌𝐄𓆩💜𓆪          \x1b[38;5;196m║ \x1b[1;96m𓆩EMON𓆪       \x1b[38;5;196m║
\x1b[38;5;196m║  \x1b[1;96m𓆩💜𓆪𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊𓆩💜𓆪      \x1b[38;5;196m║ \x1b[1;96m𓆩EMON𓆪       \x1b[38;5;196m║
\x1b[38;5;196m║  \x1b[1;96m𓆩💜𓆪𝐅𝐑𝐎𝐌𓆩💜𓆪          \x1b[38;5;196m║ \x1b[1;96m𓆩𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇𓆪         \x1b[38;5;196m║
\x1b[38;5;196m║  \x1b[1;96m𓆩💜𓆪𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌𓆩💜𓆪      \x1b[38;5;196m║ \x1b[1;96m𓆩EMON-MIM𓆪       \x1b[38;5;196m║
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/MIM-EMON441/Approved/blob/main/MIM-EMON.txt').text
    if id in httpCaht:
      print("\33[1;32m[•] 𝐘𝐨𝐮 𝐤𝐞𝐲 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐲 𝐀𝐩𝐨𝐫𝐨𝐯𝐞𝐝")
      os.system('espeak -a 300 " permission granted"')
      time.sleep(0.2)
      os.system('espeak -a 300 " WELCOME TO EMON MIM LOVE FILE CLONING TOOLS"')
      msg = str(os.geteuid())
      time.sleep(0.5)
      menu()
    else:
      ...
      print("\33[1;30m     ====================")
      print("\33[1;36m  [•] 15 Days 350 tk ")
      print("\33[1;36m  [•] 30 Days 700 tk ")
      print('\33[1;37m=========================================================')
      ...
      tks = ('AssalamuAlaylum%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Key%20:%20'+id);os.system('xdg-open https://wa.me/+8801712034653?text='+tks)
      time.sleep(1)
      exit()
  except:
    sys.exit()
...
def ckx():
    uuid = str(os.geteuid()) + str(os.getlogin())
    id = "-".join(uuid)
    server = requests.get(f'https://github.com/MIM-EMON441/Approved/blob/main/MIM-EMON.txt').text
    try:
        httpCaht = requests.get(f"https://github.com/MIM-EMON441/Approved/blob/main/MIM-EMON.txt").text
        if id in httpCaht:
            msg = str(os.geteuid())
            #pass
        else:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/emonmim.txt  Etc...]')
